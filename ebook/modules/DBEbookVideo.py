...
def DBCreateEbookVideo(ebook_id: int,
    ...
    try:
        ...
        ebook_video_id = cursor.lastrowid  # 自增ID(尾部)
    finally:
...
if __name__ == "__main__":
     #print(DBCreateEbookVideo(ebook_id=2, name="shouentesting3", ="public")) #創建ebook_video
     #print(DBEditEbookVideo(ebook_video_id=203 , name="Google home",="private"))  #修改ebook_video
     #DBDeleteEbookVideo(ebook_video_id=211) #刪除ebook_video
     #print(DBShowAllEbookVideos(ebook_id=1))  #顯示該使用者所有有權限看到的 ebooks_videos
     #print(DBSearchAllEbookVideos(ebook_id=8,name="sh")) #搜尋該使用者所有有權限看到的 ebooks_videos
     #print(DBUseIdGetEbookVideo(ebook_video_id = 5555)) #用id找ebook_video
    pass